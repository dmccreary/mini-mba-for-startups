...
The learning graph captures how concepts in *Ole Cup Entrepreneurship* depend on each other. It is a Directed Acyclic Graph (DAG) — every concept has a path back to one or more foundational concepts that have no prerequisites.
